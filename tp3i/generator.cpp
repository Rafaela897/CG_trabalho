...
void drawSphere(float radius,int slices,int stack, string fileName)
{
	...
	for (int i = 0; i<  slices; i++) {
		...
		//ponto
			...
			x= 0.5 + (atan2(radius*cos((stack / 2 - j)* b)*sin((i+1)*a),radius*cos((stack / 2 - j)* b)*cos((i+1)*a))/(2*M_PI));
			y= 0.5 - (asin(radius*sin((stack / 2 - j)* b))/M_PI);
			//normal
			...
			y= 0.5 - (asin(radius*sin((stack / 2 - j)* b))/M_PI);
			x= 0.5 + (atan2(radius*cos((stack / 2 - j)* b)*sin(i*a),radius*cos((stack / 2 - j)* b)*cos(i*a))/(2*M_PI));
			...
			x= 0.5 + (atan2(radius*cos((stack / 2 - (j+1))* b)*sin((i+1)*a),radius*cos((stack / 2 - (j+1))* b)*cos((i+1)*a))/(2*M_PI));
			y= 0.5 - (asin(radius*sin((stack / 2 - (j+1))* b))/M_PI);
			...
			x= 0.5 + (atan2(cos((stack / 2 - (j+1))* b)*sin(i*a) ,radius*cos((stack / 2 - (j+1))* b)*cos(i*a)) / (2*M_PI));
			y= 0.5 - (asin(radius*sin((stack / 2 - (j+1))* b)) / M_PI);
